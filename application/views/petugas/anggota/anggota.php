            ...
            <table id="zero_config" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a type="button" href="<?php echo base_url('anggota/ubah/'.$user->id_anggota); ?>" class="btn btn-warning"><i class="mdi mdi-pencil"></i> <span>Ubah</span></a>
                              <a type="button" href="<?php echo base_url('anggota/hapus/'.$user->id_anggota); ?>" class="btn btn-danger"><i class="mdi mdi-delete"></i> <span>Hapus</span></a>
                              <a type="button" href="<?php echo base_url('anggota/detail/'.$user->id_anggota); ?>" class="btn btn-info"><i class="mdi mdi-eye"></i> <span>Detail</span></a>
