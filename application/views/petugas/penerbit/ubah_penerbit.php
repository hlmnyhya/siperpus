            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0 ml-1">
                        <h3 class="font-weight-bold">Ubah Data Penerbit</h3>
   ...
   <div class="container-fluid">
    <div>
         <div class="card">
          ...
          <!-- Form Tambah Anggota -->
            <form id="formTambahAnggota" action="<?= base_url('petugas_ubah_data_penerbit') ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="nama">Nama Penerbit</label>
                    <input type="hidden" class="form-control" id="nama" name="id_penerbit"  value="<?= $user->id_penerbit?>" placeholder="Masukkan Nama Penerbit" required>
                    <input type="text" class="form-control" id="nama" name="nama"  value="<?= $user->nama?>" placeholder="Masukkan Nama Penerbit" required>
                </div>
                <div class="form-group">
